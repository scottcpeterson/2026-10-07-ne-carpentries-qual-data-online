...
# Required variables
venue: "Northeast Carpentries"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Oct 7, 14, 21, 2026"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "2:00 pm EST"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Sonia Barbosa (Harvard University)", "Ben Chiewphasa (Columbia University)", "Natalia Estrada (University at Buffalo)", "Heather Charlotte Owen (University of Rochester)", "Scott Peterson (University at Buffalo)", "Sarah Siddiqui (University of Rochester)"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Sonia Barbosa (Harvard University)", "Ben Chiewphasa (Columbia University)", "Natalia Estrada (University at Buffalo)", "Heather Charlotte Owen (University of Rochester)", "Scott Peterson (University at Buffalo)", "Sarah Siddiqui (University of Rochester)"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
# Optional variables
collaborative_notes: https://pad.carpentries.org/NECarpentries-fall-2026-qualitative-data-series # URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
